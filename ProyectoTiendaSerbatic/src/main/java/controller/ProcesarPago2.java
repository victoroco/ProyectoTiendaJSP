 ...
 */
@WebServlet("/ProcesarPago2")
public class ProcesarPago2 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ProcesarPago2() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/PagoCompletado.jsp").forward(request, response);
	}
